...
var Select = (props) => {
  ...
  const [valueNode, setValueNode] = React22.useState(null);
  const [valueNodeHasChildren, setValueNodeHasChildren] = React22.useState(false);
  ...
  const triggerPointerDownPosRef = React22.useRef(null);
  const isFormControl = trigger ? form || !!trigger.closest("form") : true;
  const [nativeOptionsSet, setNativeOptionsSet] = React22.useState(/* @__PURE__ */ new Set());
      ...
      children: [
        (0, import_jsx_runtime8.jsx)(Collection.Provider, { scope: __scopeSelect, children: (0, import_jsx_runtime8.jsx)(
          SelectNativeOptionsProvider,
          {
            ...
            onNativeOptionAdd: React22.useCallback((option) => {
              setNativeOptionsSet((prev) => new Set(prev).add(option));
            }, []),
            onNativeOptionRemove: React22.useCallback((option) => {
...
var SelectTrigger = React22.forwardRef(
  (props, forwardedRef) => {
    ...
    const pointerTypeRef = React22.useRef("touch");
...
var SelectValue = React22.forwardRef(
  (props, forwardedRef) => {
...
var SelectIcon = React22.forwardRef(
  (props, forwardedRef) => {
...
var SelectContentImpl = React22.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeSelect,
    ...
    const composedRefs = useComposedRefs(forwardedRef, (node) => setContent(node));
    const [selectedItem, setSelectedItem] = React22.useState(null);
    const [selectedItemText, setSelectedItemText] = React22.useState(
      null
    );
    const getItems = useCollection(__scopeSelect);
    const [isPositioned, setIsPositioned] = React22.useState(false);
    const firstValidItemFoundRef = React22.useRef(false);
    React22.useEffect(() => {
      if (content) return hideOthers(content);
    }, [content]);
    useFocusGuards();
    const focusFirst2 = React22.useCallback(
      (candidates) => {
    ...
    const focusSelectedItem = React22.useCallback(
    ...
    const itemRefCallback = React22.useCallback(
      (node, value, disabled) => {
    ...
    const handleItemLeave = React22.useCallback(() => content == null ? void 0 : content.focus(), [content]);
    const itemTextRefCallback = React22.useCallback(
      (node, value, disabled) => {
        const isFirstValidItem = !firstValidItemFoundRef.current && !disabled;
        const isSelectedItem = context.value !== void 0 && context.value === value;
        if (isSelectedItem || isFirstValidItem) {
...
var SelectItemAlignedPosition = React22.forwardRef((props, forwardedRef) => {
  const { __scopeSelect, onPlaced, ...popperProps } = props;
  const context = useSelectContext(CONTENT_NAME2, __scopeSelect);
  const contentContext = useSelectContentContext(CONTENT_NAME2, __scopeSelect);
  const [contentWrapper, setContentWrapper] = React22.useState(null);
  const [content, setContent] = React22.useState(null);
  const composedRefs = useComposedRefs(forwardedRef, (node) => setContent(node));
  const getItems = useCollection(__scopeSelect);
  const shouldExpandOnScrollRef = React22.useRef(false);
  const shouldRepositionRef = React22.useRef(true);
  const { viewport, selectedItem, selectedItemText, focusSelectedItem } = contentContext;
  const position = React22.useCallback(() => {
  ...
  const handleScrollButtonChange = React22.useCallback(
    (node) => {
...
var SelectPopperPosition = React22.forwardRef((props, forwardedRef) => {
  const {
    __scopeSelect,
    align = "start",
...
var SelectViewport = React22.forwardRef(
  (props, forwardedRef) => {
    const { __scopeSelect, nonce, ...viewportProps } = props;
    const contentContext = useSelectContentContext(VIEWPORT_NAME, __scopeSelect);
    const viewportContext = useSelectViewportContext(VIEWPORT_NAME, __scopeSelect);
    const composedRefs = useComposedRefs(forwardedRef, contentContext.onViewportChange);
    const prevScrollTopRef = React22.useRef(0);
...
var SelectGroup = React22.forwardRef(
  (props, forwardedRef) => {
...
var SelectLabel = React22.forwardRef(
  (props, forwardedRef) => {
...
var SelectItem = React22.forwardRef(
  (props, forwardedRef) => {
    ...
    const [textValue, setTextValue] = React22.useState(textValueProp ?? "");
    ...
    return (0, import_jsx_runtime8.jsx)(
      SelectItemContextProvider,
      {
        ...
        textId,
        isSelected,
        onItemTextChange: React22.useCallback((node) => {
...
var SelectItemText = React22.forwardRef(
  (props, forwardedRef) => {
    ...
    const [itemTextNode, setItemTextNode] = React22.useState(null);
    const composedRefs = useComposedRefs(
      forwardedRef,
    ...
    const nativeOption = React22.useMemo(
...
var SelectItemIndicator = React22.forwardRef(
  (props, forwardedRef) => {
...
var SelectScrollUpButton = React22.forwardRef((props, forwardedRef) => {
  const contentContext = useSelectContentContext(SCROLL_UP_BUTTON_NAME, props.__scopeSelect);
  const viewportContext = useSelectViewportContext(SCROLL_UP_BUTTON_NAME, props.__scopeSelect);
  const [canScrollUp, setCanScrollUp] = React22.useState(false);
...
var SelectScrollDownButton = React22.forwardRef((props, forwardedRef) => {
  const contentContext = useSelectContentContext(SCROLL_DOWN_BUTTON_NAME, props.__scopeSelect);
  const viewportContext = useSelectViewportContext(SCROLL_DOWN_BUTTON_NAME, props.__scopeSelect);
  const [canScrollDown, setCanScrollDown] = React22.useState(false);
  const composedRefs = useComposedRefs(forwardedRef, viewportContext.onScrollButtonChange);
  useLayoutEffect2(() => {
    if (contentContext.viewport && contentContext.isPositioned) {
      let handleScroll22 = function() {
...
var SelectScrollButtonImpl = React22.forwardRef((props, forwardedRef) => {
  const { __scopeSelect, onAutoScroll, ...scrollIndicatorProps } = props;
  const contentContext = useSelectContentContext("SelectScrollButton", __scopeSelect);
  const autoScrollTimerRef = React22.useRef(null);
  const getItems = useCollection(__scopeSelect);
  const clearAutoScrollTimer = React22.useCallback(() => {
...
var SelectSeparator = React22.forwardRef(
  (props, forwardedRef) => {
...
var SelectArrow = React22.forwardRef(
  (props, forwardedRef) => {
...
var SelectBubbleInput = React22.forwardRef(
...
function useTypeaheadSearch(onSearchChange) {
  ...
  const searchRef = React22.useRef("");
  const timerRef = React22.useRef(0);
  const handleTypeaheadSearch = React22.useCallback(
    (key) => {
  ...
  const resetTypeahead = React22.useCallback(() => {
    searchRef.current = "";
    window.clearTimeout(timerRef.current);
  }, []);
  React22.useEffect(() => {
