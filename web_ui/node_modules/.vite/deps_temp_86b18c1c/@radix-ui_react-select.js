...
function createSlot3(ownerName) {
  ...
  const Slot22 = React19.forwardRef((props, forwardedRef) => {
    const { children, ...slotProps } = props;
    ...
    if (slottable) {
      ...
      const newChildren = childrenArray.map((child) => {
        if (child === slottable) {
          if (React19.Children.count(newElement) > 1) return React19.Children.only(null);
          return React19.isValidElement(newElement) ? newElement.props.children : null;
        } else {
          return child;
        }
      });
      return (0, import_jsx_runtime13.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React19.isValidElement(newElement) ? React19.cloneElement(newElement, void 0, newChildren) : null });
    }
...
function createSlotClone3(ownerName) {
  const SlotClone = React19.forwardRef((props, forwardedRef) => {
    const { children, ...slotProps } = props;
    if (React19.isValidElement(children)) {
      const childrenRef = getElementRef3(children);
      const props2 = mergeProps3(slotProps, children.props);
      if (children.type !== React19.Fragment) {
        props2.ref = forwardedRef ? composeRefs(forwardedRef, childrenRef) : childrenRef;
      }
      return React19.cloneElement(children, props2);
    }
...
function isSlottable3(child) {
  return React19.isValidElement(child) && typeof child.type === "function" && "__radixId" in child.type && child.type.__radixId === SLOTTABLE_IDENTIFIER3;
}
...
var useReactEffectEvent = React20[" useEffectEvent ".trim().toString()];
var useReactInsertionEffect = React20[" useInsertionEffect ".trim().toString()];
...
var Select = (props) => {
  ...
  return (0, import_jsx_runtime15.jsx)(Root2, { ...popperScope, children: (0, import_jsx_runtime15.jsxs)(
    SelectProvider,
    {
      required,
      scope: __scopeSelect,
      ...
      disabled,
      children: [
        (0, import_jsx_runtime15.jsx)(Collection.Provider, { scope: __scopeSelect, children: (0, import_jsx_runtime15.jsx)(
        ...
        isFormControl ? (0, import_jsx_runtime15.jsxs)(
          SelectBubbleInput,
          {
            "aria-hidden": true,
            required,
            ...
            form,
            children: [
              value === void 0 ? (0, import_jsx_runtime15.jsx)("option", { value: "" }) : null,
...
var SelectTrigger = React35.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime15.jsx)(Anchor, { asChild: true, ...popperScope, children: (0, import_jsx_runtime15.jsx)(
      Primitive.button,
      {
        type: "button",
        role: "combobox",
  ...
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime15.jsx)(
      Primitive.span,
      {
        ...
        children: shouldShowPlaceholder(context.value) ? (0, import_jsx_runtime15.jsx)(import_jsx_runtime15.Fragment, { children: placeholder }) : children
      }
    );
  }
);
...
var SelectIcon = React35.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime15.jsx)(Primitive.span, { "aria-hidden": true, ...iconProps, ref: forwardedRef, children: children || "▼" });
  }
);
SelectIcon.displayName = ICON_NAME;
var PORTAL_NAME2 = "SelectPortal";
var SelectPortal = (props) => {
  return (0, import_jsx_runtime15.jsx)(Portal, { asChild: true, ...props });
};
  ...
  (props, forwardedRef) => {
    ...
    if (!context.open) {
      ...
      return frag ? ReactDOM4.createPortal(
        (0, import_jsx_runtime15.jsx)(SelectContentProvider, { scope: props.__scopeSelect, children: (0, import_jsx_runtime15.jsx)(Collection.Slot, { scope: props.__scopeSelect, children: (0, import_jsx_runtime15.jsx)("div", { children: props.children }) }) }),
        frag
      ) : null;
    }
    return (0, import_jsx_runtime15.jsx)(SelectContentImpl, { ...props, ref: forwardedRef });
  }
);
...
var Slot4 = createSlot3("SelectContent.RemoveScroll");
var SelectContentImpl = React35.forwardRef(
  (props, forwardedRef) => {
    ...
    useFocusGuards();
    const focusFirst2 = React35.useCallback(
      (candidates) => {
    ...
    const handleItemLeave = React35.useCallback(() => content == null ? void 0 : content.focus(), [content]);
    ...
    return (0, import_jsx_runtime15.jsx)(
      SelectContentProvider,
      {
        ...
        isPositioned,
        searchRef,
        children: (0, import_jsx_runtime15.jsx)(Combination_default, { as: Slot4, allowPinchZoom: true, children: (0, import_jsx_runtime15.jsx)(
          FocusScope,
          {
            asChild: true,
...
var SelectViewport = React35.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime15.jsxs)(import_jsx_runtime15.Fragment, { children: [
      ...
      (0, import_jsx_runtime15.jsx)(Collection.Slot, { scope: __scopeSelect, children: (0, import_jsx_runtime15.jsx)(
        Primitive.div,
        {
...
var SelectGroup = React35.forwardRef(
  (props, forwardedRef) => {
    ...
    const groupId = useId();
    return (0, import_jsx_runtime15.jsx)(SelectGroupContextProvider, { scope: __scopeSelect, id: groupId, children: (0, import_jsx_runtime15.jsx)(Primitive.div, { role: "group", "aria-labelledby": groupId, ...groupProps, ref: forwardedRef }) });
  }
);
...
var SelectLabel = React35.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime15.jsx)(Primitive.div, { id: groupContext.id, ...labelProps, ref: forwardedRef });
  }
);
...
var SelectItemText = React35.forwardRef(
  (props, forwardedRef) => {
    ...
    const nativeOption = React35.useMemo(
      () => (0, import_jsx_runtime15.jsx)("option", { value: itemContext.value, disabled: itemContext.disabled, children: textContent }, itemContext.value),
    ...
    return (0, import_jsx_runtime15.jsxs)(import_jsx_runtime15.Fragment, { children: [
      (0, import_jsx_runtime15.jsx)(Primitive.span, { id: itemContext.textId, ...itemTextProps, ref: composedRefs }),
...
var SelectItemIndicator = React35.forwardRef(
  (props, forwardedRef) => {
    ...
    return itemContext.isSelected ? (0, import_jsx_runtime15.jsx)(Primitive.span, { "aria-hidden": true, ...itemIndicatorProps, ref: forwardedRef }) : null;
  }
);
...
var SelectScrollUpButton = React35.forwardRef((props, forwardedRef) => {
  ...
  return canScrollUp ? (0, import_jsx_runtime15.jsx)(
...
var SelectScrollDownButton = React35.forwardRef((props, forwardedRef) => {
  ...
  return canScrollDown ? (0, import_jsx_runtime15.jsx)(
    SelectScrollButtonImpl,
    {
      ...props,
      ref: composedRefs,
...
var SelectSeparator = React35.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime15.jsx)(Primitive.div, { "aria-hidden": true, ...separatorProps, ref: forwardedRef });
  }
);
...
var SelectArrow = React35.forwardRef(
  (props, forwardedRef) => {
    ...
    return context.open && contentContext.position === "popper" ? (0, import_jsx_runtime15.jsx)(Arrow2, { ...popperScope, ...arrowProps, ref: forwardedRef }) : null;
  }
);
